...
//lifeCycle  loadView->viewDidLoad->viewWillAppear:->viewWillLayoutSubviews->viewDidAppear:
- (void)viewWillLayoutSubviews
{
    [super viewWillLayoutSubviews];
    _leftTableView.frame = CGRectMake(0, 20, leftTableWidth, ScreenHeight - 20);
    _rightTableView.frame = CGRectMake(leftTableWidth, 20, rightTableWidth, ScreenHeight - 20);
}
